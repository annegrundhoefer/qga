            ...
            <div id="header-wrap">
                ...
                <div class="container clearfix">
                    ...
                    <div id="logo" class="interior">
                        <a href="index.php" class="standard-logo" data-dark-logo="images/color.svg"><img src="images/color.svg" alt="Canvas Logo"></a>
                    ...
                    <nav id="primary-menu" class="style-3">
                        ...
                        <ul>
                            ...
                            <li><a href="projects.php"><div>Projects</div></a></li>
                            <li><a href="services.php"><div>Services</div></a>
                            <li><a href="about.php"><div>Firm</div></a></li>
                            <li><a href="news.php"><div>News</div></a></li>
                            <li class="current"><a href="contact.php" class="sf-with-ul"><div>Contact Us</div></a></li>
                        </ul>
