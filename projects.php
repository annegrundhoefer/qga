            ...
            <div class="content-wrap nobottompadding">
                ...
                <div class="container clearfix">
                    ...
                    <ul id="portfolio-filter" class="clearfix">
                        ...
                        <li><a href="#" data-filter=".pf-icons">Commercial</a></li>
                        <li><a href="#" data-filter=".pf-illustrations">Religious</a></li>
                        <li><a href="#" data-filter=".pf-uielements">Historic</a></li>
                        <li><a href="#" data-filter=".pf-media">Recreational</a></li>
                        <li><a href="#" data-filter=".pf-graphics">Educational</a></li>
